      ...
      <div className="flex mx-44 justify-between text-2xl">
        ...
        <div className="flex py-3 text-gray-400">
          <div className="mx-[15px] text-[15px] font-medium">
            <span className="px-[15px] hover:text-black cursor-pointer transition-colors duration-700">
              Home
            </span>
            <span className="px-[15px] hover:text-black cursor-pointer transition-colors duration-700">
              Services
          ...
          <div className="flex py-2 text-black space-x-4 text-base">
            <FontAwesomeIcon
              ...
              className="hover:text-orange-500 cursor-pointer mr-10 transition-colors duration-700 "
            />
            <FontAwesomeIcon
              icon={faFacebookF}
              className="hover:text-orange-500 cursor-pointer transition-colors duration-700"
            />
            <FontAwesomeIcon
              icon={faTwitter}
              className="hover:text-orange-500 cursor-pointer transition-colors duration-700"
