...
import { faCode, faDiagramSuccessor, faGlobe, faUser } from "@fortawesome/free-solid-svg-icons";
  ...
  return (
    <div className=' px-[15px] justify-center py-24'>
        <div className='text-4xl justify-center w-auto text-center '>
            ...
            <p className='text-[15px] '>At Westy Agency, we shows only the best websites and portfolios built completely with passion, simplicity & creativity !</p>

        </div>
        <div className="grid grid-cols-3 justify-center items-center w-[1140px] h-[714px] mx-auto place-items-center ">
                    <img
                        src={Image_8} alt=""className="w-[340px] h-[198px] transition-transform duration-300 ease-in-out bg-[#226ACB]  hover:bg-[#226ACB] cursor-pointer"
                    />
                    <img
                        src={Image_8} alt=""className="w-[340px] h-[198px] transition-transform duration-300 ease-in-out bg-[#226ACB] "
                    />
                    <img
                        src={Image_8} alt=""className="w-[340px] h-[198px] transition-transform duration-300 ease-in-out bg-[#226ACB] "
                    />
                    ...
                    />
                    <img
                        src={Image_8} alt=""className="w-[340px] h-[198px] transition-transform duration-300 ease-in-out hover:bg-[#226ACB] "
                    />
                    </div>
                    ...
                    <div className="relative mt-60 h-[272px]">
                            ...
                            <div className="absolute top-0 left-0 w-[1170px] h-[272px] bg-cyan-600 bg-opacity-90 mx-40 flex items-center justify-center">
                                <div className='flex space-x-10'>
                                    <div className='flex pt-[40px] px-[15px]'>
                                        <FontAwesomeIcon icon={faUser} className=" mr-5 text-4xl text-white border-4 p-4" />
                                        <div >
                                    ...
                                    <div className='flex pt-[40px] px-[15px]'>
                                    <FontAwesomeIcon icon={faGlobe} className=" text-4xl text-white border-4 p-4 mr-5" />
                                    ...
                                    <div className='flex pt-[40px] px-[15px]'>
                                    <FontAwesomeIcon icon={faCode} className=" mr-5 text-3xl text-white border-4 p-4" />
                                        <div>
                                    ...
                                    <div className='flex pt-[40px] px-[15px]'>
                                    <FontAwesomeIcon icon={faDiagramSuccessor} className=" mr-5 text-4xl text-white border-4 p-4" />
                                        <div>
                            ...
                            <div className='flex'>
                                ...
                                <div className="relative overflow-hidden">
                                    ...
                                    <div className="text-[198px] font-bold text-[#F7F7F8]">CASE STUDY</div>
                                    </div>
                                </div>

                                    <div className='py-10 px-4 space-y-6'>
                                        <button className='border-2 border-blue-600 cursor-pointer hover:bg-sky-600 px-10 py-2 text-blue-500 font-medium hover:text-white'>Study 01</button>
                                        <p className='text-3xl font-bold'>Vision to plan</p>
                                        <p className='text-[#7A7A7A]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco.</p>
                                        <ul className="list-none space-y-2 text-[#7A7A7A]">
                                            <li className="flex items-center space-x-2">
                                                <input type="checkbox" className="w-4 h-4 text-green-500 accent-green-500" />
                                                <span>Ut perspiciatis unde omnis iste natus error sit volupt atem.</span>
                                            </li>
                                            <li className="flex items-center space-x-2">
                                                <input type="checkbox" className="w-4 h-4 text-green-500 accent-green-500" />
                                            ...
                                            <li className="flex items-center space-x-2">
                                                <input type="checkbox" className="w-4 h-4 text-green-500 accent-green-500" />
                                                <span>Eaque ipsa quae ab illo inventore veritatis et quasi</span>
                                            </li>
                                        </ul>
                            ...
                            <div className='flex'>
                                ...
                                <div className='px-4 pt-8 pb-16 space-y-6'>
                                        <button className='border-2 border-blue-600 cursor-pointer hover:bg-sky-600 px-10 py-2 text-blue-500 font-medium hover:text-white'>Study 02</button>
                                        <p className='text-3xl font-bold'>Our Growth</p>
                                        <p className='text-[#7A7A7A]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                                        <div className="space-y-6">
                                                    {/* Consulting */}
                                                    <div className="flex items-center">
                                                        <span className="text-lg font-bold text-gray-800 w-32">Consulting</span>
                                                    ...
                                                    {/* Finance */}
                                                    <div className="flex items-center">
                                                        <span className="text-lg font-bold text-gray-800 w-32">Finance</span>
                                                        <div className="relative w-full">
                                                        <div className="absolute top-1/2 w-full border-t-2 border-yellow-500"></div>
                                                    ...
                                                    {/* Business */}
                                                    <div className="flex items-center">
                                                        <span className="text-lg font-bold text-gray-800 w-32">Business</span>
                                                        <div className="relative w-full">
                                                        <div className="absolute top-1/2 w-full border-t-2 border-yellow-500"></div>
